...
class Driver1 {
	public static void main(String[] args) {
		...
		for (BankAccount1[] array : baArrays) {
			...
			try {
				System.out.println("avg Bank Bal: " + Question1.averageBankBalance(array));
			} catch (IllegalArgumentException e) {
				System.out.println(e.getMessage());
			}

			try {
				System.out.println("Lowest Bank Bal: " + Question1.lowestBankBalance(array));
			} catch (IllegalArgumentException e) {
				System.out.println(e.getMessage());
			}

			try {
				System.out.println("Longest Name: " + Question1.longestName(array));
			} catch (IllegalArgumentException e) {
				System.out.println(e.getMessage());
			}
		}
		...
		for (Customer[] array : cArrays) {
			System.out.println("\nCurrent Array: " + Arrays.toString(array));
			try {
				System.out.println("Avg Customer Bal: " + Question1.averageCustomerBalance(array));
			} catch (IllegalArgumentException e) {
				System.out.println(e.getMessage());
			}

			try {
				System.out.println("Greatest Customer Bal: " + Question1.greatestCustomerBalance(array));
			} catch (IllegalArgumentException e) {
				System.out.println(e.getMessage());
			}
		}
